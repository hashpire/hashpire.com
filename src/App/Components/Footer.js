    ...
    <Container textAlign='center'>
      <Grid divided inverted stackable>
        ...
        <Grid.Column width={5} verticalAlign='middle'>
          ...
          <p>
            Hashpire เป็นชุมชนของผู้ที่ชื่นชอบเทคโนโลยี web3 อาทิ บล็อกเชนและการจัดเก็บข้อมูลแบบกระจายอำนาจ ภารกิจของเราคือการพลักดันวิสัยทัศน์ของ Web3 ให้เป็นจริง และ สร้างแรงบันดาลใจให้โลกได้รู้เกี่ยวกับพลังแห่ง HASH
          </p>
        </Grid.Column>
      </Grid>
